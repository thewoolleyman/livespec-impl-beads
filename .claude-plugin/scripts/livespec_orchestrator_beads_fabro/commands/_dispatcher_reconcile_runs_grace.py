...
The coercion genuinely is peculiar to this arm: `0` is a MEANINGFUL value here
and not a degenerate one, so this setting floors at zero where every other
bound in that module floors at one.
"""
