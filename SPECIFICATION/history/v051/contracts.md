...
| `ready` | move→backlog (withdraw); move→blocked (park); driver-dispatch (host-only-refused items only); set-acceptance; acceptance-rework-cap; merge-on-review-cap; review-fix-cap |
